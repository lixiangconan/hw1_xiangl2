 ...
 * @generated */
public class AnswerScore_Type extends TextAnnotationBase_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("xiangl2.infosystem.output.AnswerScore");
  ...
  public int getAnswer(int addr) {
      ...
      jcas.throwFeatMissing("answer", "xiangl2.infosystem.output.AnswerScore");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "xiangl2.infosystem.output.AnswerScore");
  ...
  public AnswerScore_Type(JCas jcas, Type casType) {
    ...
    casFeat_answer = jcas.getRequiredFeatureDE(casType, "answer", "xiangl2.infosystem.input.Answer", featOkTst);
